...
;layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    }, s = "table", u = ".layui-table", y = "layui-hide", h = "layui-none", f = "layui-table-view", p = ".layui-table-tool", v = ".layui-table-box", m = ".layui-table-init", g = ".layui-table-header", b = ".layui-table-body", x = ".layui-table-main", k = ".layui-table-fixed", C = ".layui-table-fixed-l", w = ".layui-table-fixed-r", T = ".layui-table-total", A = ".layui-table-page", L = ".layui-table-sort", S = "layui-table-edit", N = "layui-table-hover", W = function (e) {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (result) {
                                            if(result.code == 200){
                                                ...
                                                d.exportFile(o.id, result.data, e)
                                            }else{
                                                layer.msg('导出失败,登录失效', {time:2000})
                                            }
                                        }
                                    });
